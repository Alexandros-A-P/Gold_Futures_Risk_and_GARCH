...
- Distributive properties of Gold futures.

Chapter 3: Forecasting
- AR(1), MA(2) and random walk models comapred under AIC.

Chapter 4: Volatility modelling  
- ARCH and GARCH
- GARCH(1,1) formula, results and interpretation

Chapter 5: Limits and Discussion (word doc only)
